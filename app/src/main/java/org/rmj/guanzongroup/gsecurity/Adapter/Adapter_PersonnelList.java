...
public class Adapter_PersonnelList extends RecyclerView.Adapter<Adapter_PersonnelList.VHPersonnels> {

    public final List<String> poPersonnels;

    public Adapter_PersonnelList(List<String> poPersonnels) {
